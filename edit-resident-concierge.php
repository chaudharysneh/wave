      ...
      <div class="container-fluid py-1 px-3 mt-3">
        <nav aria-label="breadcrumb mt-4">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-dark active" aria-current="page">Edit Apartment Member</li>
          </ol>
        </nav>
		...
		<div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
			<div class="card">
				<div class="card-header bg-dark text-white">					
	                ...
	                <h4 class="text-white mb-0">Edit Apartment Member</h4>
				...
				<form method="POST" action="https://portal.aptlymanaged.com/apartment/2350" accept-charset="UTF-8" role="form" id="create-user" novalidate="novalidate"><input name="_method" type="hidden" value="PATCH"><input name="_token" type="hidden" value="GBmvPKRydnhhv9WnYvN5p1safhB4NcQ5qQxyRDaw">
    <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <select class="select2 select2-hidden-accessible form-control" id="unit_id" name="unit_id" data-select2-id="select2-data-unit_id" tabindex="-1" aria-hidden="true">
            	...
            	<option value="874" selected="selected" data-select2-id="select2-data-2-4w2e">B-1611</option></select>
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <select class="form-control" id="member_type" name="member_type">
            	...
            	<option value="owner_living" selected="selected">Owner - Living at property</option>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <input class="form-control " placeholder="First Name" name="first_name" type="text" value="test" id="first_name">
                    </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <input class="form-control " placeholder="Last Name" name="last_name" type="text" value="xyz" id="last_name">
                    </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <input class="form-control " placeholder="Contact Number" name="phone_number" type="text" value="+1 (946) 869-1993" id="phone_number">
                </div>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="hidden" name="member_images" id="profile-img-tag-textarea">
                        <input type="file" name="member_image" id="member_image-1" class="inputfile inputfile-1" value="1726219166.png">
            <br>
            <br>
            <img src="./assets/img/team-2.jpg" width="80" height="80" id="career_img">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <input class="form-control " placeholder="Address" name="address" type="text" value="Et doloremque quis d" id="address">
                    </div>
    </div>
    <div class="col-md-2">
        <div class="form-group ">
            <label for="city" class="control-label">City</label>
            <input class="form-control " placeholder="City" name="city" type="text" value="Est natus do ut eos" id="city">
                    </div>
    </div>
    <div class="col-md-2">
        <div class="form-group ">
            <label for="country" class="control-label">Country</label>
            <input class="form-control " placeholder="Country" name="country" type="text" value="Enim ea neque dolor" id="country">
                    </div>
    </div>
    <div class="col-md-2">
        <div class="form-group ">
            <label for="zip_code" class="control-label">Postal Code</label>
            <input class="form-control " placeholder="Postal Code" name="zip_code" type="text" value="64293" id="zip_code">
                    </div>
    </div>
</div>
<hr class="bg-dark">
