      ...
      <div class="container-fluid py-1 px-3 mt-3">
        <nav aria-label="breadcrumb mt-4">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-dark active" aria-current="page">Edit Apartment Units</li>
          </ol>
        </nav>
...
<div class="container-fluid py-4 pt-0">
		...
		<div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
			<div class="card">
				<div class="card-header bg-dark text-white">					
	                ...
	                <h4 class="text-white mb-0">Edit Apartment Number</h4>
    ...
    <div class="col-md-4">
        <div class="form-group ">
            ...
            <input class="form-control " placeholder="Apartment Number" name="flat_number" type="text" value="102" id="flat_number">
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            <label for="no_of_keys" class="control-label">No of keys</label>
            <input class="form-control " placeholder="No. of Keys" name="no_of_keys" type="text" value="5" id="no_of_keys">
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            <label for="parking_option" class="control-label">Parking Bay / Permit Number</label>
            <input class="form-control " placeholder="Parking Bay / Permit Number" name="parking_option" type="text" value="11" id="parking_option">
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            <label for="key_waiver" class="control-label">Key Waiver</label>
            <input class="form-control " placeholder="Key Waiver" name="key_waiver" type="text" value="33" id="key_waiver">
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            <label for="letting_agent_info" class="control-label">Letting Agent Information</label>
            <input class="form-control " placeholder="Letting Agent Information" name="letting_agent_info" type="text" value="22" id="letting_agent_info">
                    </div>
    </div>
    <div class="col-md-4">
        <div class="form-group ">
            <label for="bicycle_scooter_info" class="control-label">Bicycle / Scooter Information</label>
            <input class="form-control " placeholder="Bicycle / Scooter Information" name="bicycle_scooter_info" type="text" value="44" id="bicycle_scooter_info">
                    </div>
    </div>
</div>
<div class="row">
    <div class="col-md-3">
        <div class="form-group ">
            ...
            <input class="form-control " placeholder="Documents File 1 Name" name="documents_files_label[]" type="text" value="sample-2.pdf">
                    </div>
    </div>
    <div class="col-md-3">
        <div class="form-group ">
            ...
            <input name="documents_files[]" type="file">
                            ...
                            <p><a href="./docs/sample-2.pdf" target="_blank">sample-2.pdf</a>
                    <div class="input-rc"><input type="checkbox" id="delete_files_chk_0" name="delete_files_chk[]" class="delete_files_chk" data-id="<a href=&quot;https://portal.aptlymanaged.com/public/front/documents_files/1700516553_0.pdf&quot; target=&quot;_blank&quot;>sample-2.pdf</a>" value="1700516553_0.pdf"><span class="input-rc-span"></span></div> Delete
                </p>
