...
<div class="container-fluid py-4">
  <div class="row">
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      <div class="card" style="background-image: linear-gradient(310deg, #e8ebef 0%, #95c7fd 100%); border-radius: 15px;">
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      <div class="card" style="background-image: linear-gradient(310deg, #d9efe8 0%, #a6dfcf 100%); border-radius: 15px;">
      <!-- <div class="card" style="border-radius: 15px;"> -->
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
    ...
    <div class="col-xl-3 col-sm-6">
      <div class="card" style="background-image: linear-gradient(310deg, #f3e3dc 0%, #f1b89d 100%); border-radius: 15px;">
      <!-- <div class="card" style="border-radius: 15px;"> -->
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
  ...
  <div class="row mt-4">
    <div class="col-lg-6 mb-lg-0 mb-4">
      <div class="card z-index-2 h-100" style="border-radius: 15px;">
        <div class="card-header pb-0 pt-3 bg-transparent">
          <h4 class="text-capitalize dark-text">Quick Views</h4>
        </div>
        <div class="card-body p-3">
          <!-- <div class="chart">
    ...
    <div class="col-lg-6">
      <div class="card " style="border-radius: 15px;">
        <div class="card-header pb-0 pt-3 bg-transparent">
          <h4 class="text-capitalize dark-text">Calendar </h4>
        </div>
        <div class="card-body p-3">
          <div id='calendar'></div>
        </div>
  ...
  <div class="row mt-4">
      ...
      <div class="card" style="border-radius: 15px;">
        <div class="card-header dark-bg py-2">
          <div class="d-flex justify-content-between align-items-baseline">
            <h4 class="mb-0 text-light">Services</h4>
            <button type="button" class="d-flex align-items-center  font-pop btn btn-block btn-light dark-text ms-auto mb-0" data-bs-toggle="modal" data-bs-target="#modal-services"><i class="ni ni-settings-gear-65"></i>&nbsp;&nbsp;Add Services</button>
          </div>
        </div>
          ...
          <table class="table table-flush dataTable-table mt-3" id="datatable-basic">
            ...
            <thead class="thead-light">
              <tr role="row align-items-center">
                <th class="dark-text font-weight-bolder sort" data-sortable="">#</th>
                <th scope="col" class="dark-text font-weight-bolder sort" data-sort="status">Service Provider</th>
                <th scope="col" class="dark-text font-weight-bolder sort">Contact No</th>
                <th scope="col" class="dark-text font-weight-bolder sort">Action</th>
              </tr>
            </thead>
            <tbody>
              <tr class="dark-text" role="row">
                <td>1</td>
                <td>ABC</td>
                <td>09454959444</td>
                <td>
                  <div class="d-flex">
                    <button type="button" class="btn p-0 bg-light d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#exampleModal" style="height: 30px; width: 30px;">
                      <i class="fa fa-pencil-square dark-text opacity-10"></i>
                    </button>

                    <button type="button" class="btn p-0 btn-block del-btn bg-light mb-3 d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#modal-delete" style="height: 30px; width: 30px;"><i class="fa fa-trash dark-text opacity-10"></i></button>
              ...
              <tr class="dark-text" role="row">
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <button type="button" class="btn bg-light d-flex align-items-center justify-content-center p-0" data-bs-toggle="modal" data-bs-target="#exampleModal" style="height: 30px; width: 30px;">
                      <i class="fa fa-pencil-square dark-text opacity-10"></i>
                    </button>
                    ...
                    <button type="button" class="btn btn-block del-btn bg-light mb-3 p-0 d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#modal-delete" style="height: 30px; width: 30px;"><i class="fa fa-trash dark-text opacity-10"></i></button>
                  </div>
                </td>
              </tr>
    ...
    <div class="col-lg-6">
      <div class="card " style="border-radius: 15px;">
        <div class="card-header dark-bg py-2">
          <div class="d-flex justify-content-between align-items-baseline">
            <h4 class="mb-0 heading-left text-light">Notifications</h4>
            <div class="btn-right d-flex flex-row gap-2"> <button class="d-flex align-items-center font-pop btn btn-light dark-text ms-auto mb-0"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete All</button>
              <button class="d-flex align-items-center font-pop btn btn-light dark-text ms-auto mb-0"><i class="ni ni-check-bold"></i>&nbsp;&nbsp;Mark as Read</button>
            </div>
          </div>
        </div>
        <div class="card-body p-3">
          ...
          <div class="bill d-flex">
            <div class="input-rc p-2 check-input">
              <input type="checkbox" class="sub_chk" data-id="cd06f715-4566-41bc-8155-6e9ef02962fa"><span class="input-rc-span"></span>
            </div>
            <h6 class="mb-0">
              <div class="status bg-actor"></div>
              <a href="chat.php">
                <span class="dark-text">test Fablead has sent you a new message</span> </a>
            </h6>
            <a href="#" class="ms-auto btn btn-small bill-btn p-1 mb-0"><i class="align-items-center bg-light d-flex dark-text fa fa-trash justify-content-center rounded" aria-hidden="true" style="height: 30px;width:30px;"></i>
            </a>
          </div>
          <div class="bill d-flex">
